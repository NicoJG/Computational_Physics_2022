	       ...
	       )
{
	...
	double* linear_array = (double*)calloc(nrows*ncols,sizeof(double));
...
/* calculate the matrix vector product and save it in vec_out
 * @vec_out - shape: n_rows
 * @mat - shape: n_rows x n_cols
 * @vec - shape: n_cols
 */
void matrix_vector_product(double* vec_out, double** mat, double* vec, int n_rows, int n_cols){
